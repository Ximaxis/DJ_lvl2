...
urlpatterns = [
    ...
    path("categories/update/<slug:slug>/", adminapp.ProductCategoryUpdateView.as_view(), name="category_update"),
    path("categories/delete/<slug:slug>/", adminapp.ProductCategoryDeleteView.as_view(), name="category_delete"),
    ...
    path("products/read/<slug:slug>/", adminapp.ProductDetailView.as_view(), name="product_read"),
